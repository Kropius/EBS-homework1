...
class GenerateSubscriptions:
    ...
    def generate_value(self, key_name):
        if key_name == 'wind_direction':
            ...
            return generate_dates(1)[0]
        elif key_name == 'wind_speed':
            return generate_wind_speeds(1)[0]
        elif key_name == 'rain_chance':
            return generate_rain_chance(1)[0]
    ...
    def generate_subscriptions(self):
        ...
        for index in range(self.total_number_of_subscriptions):
            ...
            for key in self.field_occurrences:
                ...
                if self.field_occurrences[key] == remaining_subscriptions or (
